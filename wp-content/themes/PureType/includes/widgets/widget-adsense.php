<?php class AdsenseWidget extends WP_Widget
{
    function AdsenseWidget(){
		$widget_ops = array('description' => __('Displays Adsense Ads'));
...
<?php
  ...
  /*Creates the form for the widget in the back-end. */
    function form($instance){
		...
		# Adsense Code
		echo '<p><label for="' . $this->get_field_id('adsenseCode') . '">' . __('Adsense Code:') . '</label><textarea cols="20" rows="12" class="widefat" id="' . $this->get_field_id('adsenseCode') . '" name="' . $this->get_field_name('adsenseCode') . '" >'. $adsenseCode .'</textarea></p>';	
	}
