...
<div class="side_box">
    <div class="menu tabbed">
        <ul class="tabs">
            <li class="t1"><a class="t1 tab" title="<?php _e('Latest Headlines'); ?>">
                <?php _e('Comments'); ?>
                </a></li>
            <li class="t3"><a class="t3 tab" title="<?php _e('Categories'); ?>">
                <?php _e('Recent'); ?>
                </a></li>
            <li class="t4"><a class="t4 tab" title="<?php _e('Archives'); ?>">
                <?php _e('Archives'); ?>
                </a></li>
        </ul>
        <!-- LATEST HEADLINES -->
