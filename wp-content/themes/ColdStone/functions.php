	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Stone", "Nature", "Glow", "Grunge")),
			...
			array( "name" => "Post Format",
				   ...
				   "std" => "Business",
				   "desc" => "desc.",
				   "options" => array("Business", "Blog Style", "Magazine Style")),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Exclude categories from recent posts",
		...
		array( "name" => "general-3",
			...
			array( "name" => "Duplicate Featured Articles",
				   "id" => $shortname."_duplicate_featured",
				   "type" => "checkbox",
				   "std" => "false",
				   "desc" => "desc",),
			...
			array( "name" => "Number of Featured Articles To Be Displayed",
	...
	array( "name" => "wrap-navigation",
		...
		array( "name" => "navigation-2",
			...
			array( "name" => "Hide Empty Categories",
				   ...
				   "type" => "checkbox",
				   "std" => "on",
				   "desc" => "Enabling this feature will remove empty categories from your navigation bar."),
		...
		array( "name" => "navigation-3",
			...
			array( "name" => "Enable Search Bar",
            		"id" => $shortname."_search",
            		"type" => "checkbox",
            		"std" => "on",
					"desc" => "If you would like to display the search form in the navigation menu then enable this option."),
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "wrap-layout",
		...
		array( "name" => "layout-1",
			...
			array( "name" => "Display Post Info Bar",
		...
		array( "name" => "layout-3",
			...
			array( "name" => "Display General Post Info Bar",
				   "id" => $shortname."_postinfo_bar",
            	   "type" => "checkbox",
            	   "std" => "on",
            	   "desc" => "desc."),
		...
		array( "name" => "layout-4",
			...
			array( "name" => "Enable Page Navi",
				   "id" => $shortname."_pagenavi",
            	   "type" => "checkbox",
            	   "std" => "on",
            	   "desc" => "If you would like to include pagenavi on the homepage, which will allow visitors to view older posts without clicking on the categories/archive links, enable this option."),
			
			array( "name" => "Enable Tabbed Items",
				   "id" => $shortname."_tabs",
            	   "type" => "checkbox",
            	   "std" => "on",
            	   "desc" => "On the homepage of the Business style of Coldstone there is a tabbed menu that includes recent posts, comments and archives. You can enable or disable this section here."),
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "wrap-colorization",
		...
		array( "name" => "colorization-1",
		    ...
		    array( "name" => "Post headings color",
				   "id" => $shortname."_color_headings_title",
				   "type" => "textcolorpopup",
				   "std" => "",
				   "desc" => "This option allows you to customize the color of a certain element of the theme. When you click inside the field a color picker will appear. Scroll to find your desired color and then click the circular submit button on the lower right to accept the value",),
				   
			array( "name" => "Post headings background color",
				   "id" => $shortname."_color_headingsbg_title",
				   "type" => "textcolorpopup",
				   "std" => "",
				   "desc" => "This option allows you to customize the color of a certain element of the theme. When you click inside the field a color picker will appear. Scroll to find your desired color and then click the circular submit button on the lower right to accept the value",),
				   				   
			array( "name" => "Page/Single Post heading title color",
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "wrap-advertisements",
		...
		array( "name" => "advertisements-1",
			...
			array( "name" => "Enable 125x125 banners in the Featured Area",
				   "id" => $shortname."_ads",
				   	"type" => "checkbox",
				   "std" => "on",
				   "desc" => "desc.",),
			...
			array( "name" => "Input 125x125 Featured Area banner #1 url",
				   "id" => $shortname."_banner_url_one",
				   "type" => "text",
				   "std" => "",
				   "desc" => "desc",),
			
			array( "name" => "Input 125x125 Featured Area banner #1 image",
				   "id" => $shortname."_banner_image_one",
				   "type" => "text",
				   "std" => "",
				   "desc" => "desc",),
			
			array( "name" => "Input 125x125 Featured Area banner #2 url",
				   "id" => $shortname."_banner_url_two",
				   "type" => "text",
				   "std" => "",
				   "desc" => "desc",),
				   
			array( "name" => "Input 125x125 Featured Area banner #2 image",
		 ...
		 if ( 'save' == $_REQUEST['action'] ) {
			foreach ($options as $value) {
				if( isset( $_REQUEST[ $value['id'] ] ) ) {
					if ($value['type'] == 'textarea' || $value['type'] == 'text' || $value['type'] == 'textlimit') update_option( $value['id'], stripslashes($_REQUEST[$value['id']]) );
					elseif ($value['type'] == 'select') update_option( $value['id'], htmlspecialchars($_REQUEST[$value['id']]) );
